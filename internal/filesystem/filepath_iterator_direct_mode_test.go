	...
	tests := []struct {
		...
		},
		{
			...
			filesToCreate: []fileEntry{
				...
				{"03.jfif", false},
				{"other", true},
				{filepath.Join("other", "vacation"), true},
				{filepath.Join("other", "postcards"), true},
				{filepath.Join("other", "scans"), true},
			},
			expectedFiles: []string{
		...
		},
		{
			...
			filesToCreate: []fileEntry{
				...
				{"other", true},
				{filepath.Join("other", "vacation"), true},
				{filepath.Join("other", "vacation", "photo1.jpg"), false},
				{filepath.Join("other", "vacation", "photo2.jfi"), false},
				{filepath.Join("other", "vacation", "photo3.png"), false},
				{filepath.Join("other", "vacation", "photo4.tif"), false},
				{filepath.Join("other", "postcards"), true},
				{filepath.Join("other", "postcards", "happybirthday.jpg"), false},
				{filepath.Join("other", "postcards", "happynewyear.png"), false},
				{filepath.Join("other", "scans"), true},
				{filepath.Join("other", "scans", "document01.png"), false},
				{filepath.Join("other", "scans", "document02.png"), false},
				{filepath.Join("other", "scans", "document03.jPeG"), false},
				{filepath.Join("other", "scans", "document04.jFIf"), false},
			},
			expectedFiles: []string{
				"01.jpg",
				"02.jpeg",
				"03.jfif",
				filepath.Join("other", "vacation", "photo1.jpg"),
				filepath.Join("other", "vacation", "photo2.jfi"),
				filepath.Join("other", "postcards", "happybirthday.jpg"),
				filepath.Join("other", "scans", "document03.jPeG"),
				filepath.Join("other", "scans", "document04.jFIf"),
			},
		},
		{
		...
		},
		{
			...
			filesToCreate: []fileEntry{
				...
				{filepath.Join("other", "vacation", "photo3.png"), false},
				{filepath.Join("other", "vacation", "photo4.tif"), false},
				{filepath.Join("other", "books"), true},
				{filepath.Join("other", "postcards"), true},
				{filepath.Join("other", "postcards", "forkids"), true},
				{filepath.Join("other", "postcards", "happybirthday.jpg"), false},
				{filepath.Join("other", "postcards", "happynewyear.png"), false},
				{filepath.Join("other", "scans"), true},
				{filepath.Join("other", "scans", "document01.png"), false},
				...
				{filepath.Join("other", "scans", "document04.jFIf"), false},
				{"archives", true},
				{filepath.Join("archives", "old"), true},
				{filepath.Join("archives", "old", "document01.jFIf"), false},
				{filepath.Join("archives", "new"), true},
				{filepath.Join("archives", "new", "document59.png"), false},
				{filepath.Join("archives", "check"), true},
			},
			expectedFiles: []string{
				"01.jpg",
				"02.jpeg",
				...
				filepath.Join("other", "scans", "document03.jPeG"),
				filepath.Join("other", "scans", "document04.jFIf"),
				filepath.Join("archives", "old", "document01.jFIf"),
			},
		},
		{
