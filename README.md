...
## version 3.0.1 (released on March 11, 2026)
...
| ---------------- | ----------------------------------------------------------- | ------------------------------------------ |
| Windows 64-bit   | Intel/AMD PC and Laptops                                    | whatsapp_jpeg_repair_3_0_1_win_x64.zip     |
| Windows 32-bit   | Intel/AMD PC and Laptops                                    | whatsapp_jpeg_repair_3_0_1_win32.zip       |
| Windows          | New ARM Laptops (Microsoft Surface, Asus Zenbook A14, etc.) | whatsapp_jpeg_repair_3_0_1_win_arm64.zip   |
| macOS            | Apple Silicon (M1/M2/M3/etc)                                | whatsapp_jpeg_repair_3_0_1_macOS_arm64.zip |
| macOS            | Intel Processor                                             | whatsapp_jpeg_repair_3_0_1_macOS_x64.zip   |
| Linux 64-bit     | Intel/AMD PC and Laptops                                    | whatsapp_jpeg_repair_3_0_1_linux_x64.zip   |
...
1. [Which compression level is used when saving JPEG files?](#compression-level)
2. [Windows user: What is the purpose of the .bat files in the application folder?](#bat-purpose)
3. [macOS/Linux user: What is the purpose of the **.sh** files in the application folder?](#sh-purpose)
4. [How should parameters and their combinations be passed correctly when launching an application?](#param-rules)
5. [How can I specify a custom folder from which the application will take files for processing?](#custom-source-folder)
6. [How can I specify a custom folder in which the application can store the results of file processing?](#custom-dest-folder)
7. [How can the same modification time be applied to the repaired file as to the original file?](#mod-time)
8. [What steps should I take to ensure that the source files are deleted after processing?](#delete-source-files)
9. [What is the best course of action if I want all my source files, including those in subfolders, to be processed?](#recursive-processing)
10. [How can I stop the program from waiting for me to press Enter after it has finished running?](#dont-wait)
11. [How can I display information on all the possible operating modes and command line parameters?](#show-help)
12. [What if I want to process a file so that it is processed directly on the spot?](#single-file-in-direct-mode)
13. [How can the application be launched so that its output is redirected to a file?](#redirect-app-output)
14. [Why is nothing happening when I try to run a **.sh** or **.bat** file?](#cant-run-script-file)
15. [Why am I getting permission errors when I run the application?](#permission-problems)
16. [How should I go about reporting a bug or suggesting an improvement?](#how-to-report-bug)

### <a name="compression-level">1. Which compression level is used when saving JPEG files?</a>

Before version **3.0.1**, the application used a default compression setting of 75%. Starting with version **3.0.1**, however, it uses lossless compression.

### <a name="bat-purpose">2. Windows user: What is the purpose of the .bat files in the application folder?</a>
...
### <a name="sh-purpose">3. macOS/Linux user: What is the purpose of the **.sh** files in the application folder?</a>
...
### <a name="param-rules">4. How should parameters and their combinations be passed correctly when launching an application?</a>
...
### <a name="custom-source-folder">5. How can I specify a custom folder from which the application will take files for processing?</a>
...
### <a name="custom-dest-folder">6. How can I specify a custom folder in which the application can store the results of file processing?</a>
...
### <a name="mod-time">7. How can the same modification time be applied to the repaired file as to the original file?</a>
...
### <a name="delete-source-files">8. What steps should I take to ensure that the source files are deleted after processing?</a>
...
### <a name="recursive-processing">9. What is the best course of action if I want all my source files, including those in subfolders, to be processed?</a>
...
### <a name="dont-wait">10. How can I stop the program from waiting for me to press Enter after it has finished running?</a>
...
### <a name="show-help">11. How can I display information on all the possible operating modes and command line parameters?</a>
...
### <a name="single-file-in-direct-mode">12. What if I want to process a file so that it is processed directly on the spot?</a>

In the operating system's graphical shell, drag the file requiring processing onto the application's executable file icon.

### <a name="redirect-app-output">13. How can the application be launched so that its output is redirected to a file?</a>
...
### <a name="cant-run-script-file">14. Why is nothing happening when I try to run a **.sh** file?</a>
...
### <a name="permission-problems">15. Why am I getting permission errors when I run the application?</a>
...
### <a name="how-to-report-bug">16. How should I go about reporting a bug or suggesting an improvement?</a>
