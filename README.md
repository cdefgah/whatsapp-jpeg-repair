...
Follow these steps:
1. Download application archive. Navigate [this link](https://github.com/cdefgah/whatsapp-jpeg-repair/releases) to do that. Then expand `Assets` section and download either `WhatsAppJpegRepair-1.0-Windows.zip` or `WhatsApp Jpeg Image Repair (Apple MacOS version)` according to your operating system.
